...
Please see [CONTRIBUTING](https://github.com/vsouza/awesome-ios/blob/master/.github/CONTRIBUTING.md) ⭐ 53,356 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 and [CODE-OF-CONDUCT](https://github.com/vsouza/awesome-ios/blob/master/CODE_OF_CONDUCT.md) ⭐ 53,356 | 🐛 27 | 🌐 Swift | 📅 2026-08-27 for details.
...
* [The Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) ⭐ 14,909 | 🐛 25 | 🌐 Swift | 📅 2026-08-28 - The Composable Architecture is a library for building applications in a consistent and understandable way, with composition, testing, and ergonomics in mind.
...
* [web3swift](https://github.com/web3swift-team/web3swift) ⭐ 889 | 🐛 75 | 🌐 JavaScript | 📅 2025-09-24 - Elegant Web3js functionality in Swift. Native ABI parsing and smart contract interactions.
...
* [PINCache](https://github.com/pinterest/PINCache) ⭐ 2,686 | 🐛 30 | 🌐 Objective-C | 📅 2026-09-11 - Fast, non-deadlocking parallel object cache for iOS and macOS.
...
* [Charts](https://github.com/danielgindi/Charts) ⭐ 28,006 | 🐛 977 | 🌐 Swift | 📅 2026-03-07 - A powerful chart/graph framework, the iOS equivalent to [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,174 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05.
* [PNChart](https://github.com/kevinzhow/PNChart) ⭐ 9,638 | 🐛 173 | 🌐 Objective-C | 📅 2018-07-02 - A simple and beautiful chart lib used in Piner and CoinsMan for iOS.
...
* [JBChartView](https://github.com/Jawbone/JBChartView) ⭐ 3,694 | 🐛 10 | 🌐 Objective-C | 📅 2018-08-06 - iOS-based charting library for both line and bar graphs.
...
* [TEAChart](https://github.com/xhacker/TEAChart) ⭐ 1,188 | 🐛 0 | 🌐 Objective-C | 📅 2017-11-17 - Simple and intuitive iOS chart library. Contribution graph, clock chart, and bar chart.
...
* [FSInteractiveMap](https://github.com/ArthurGuibert/FSInteractiveMap) ⭐ 544 | 🐛 18 | 🌐 Objective-C | 📅 2018-10-18 - A charting library to visualize and interact with a vector map on iOS. It's like Geochart but for iOS.
...
* [ANDLineChartView](https://github.com/anaglik/ANDLineChartView) ⭐ 418 | 🐛 1 | 🌐 Objective-C | 📅 2017-03-26 - ANDLineChartView is easy to use view-based class for displaying animated line chart.
* [TWRCharts](https://github.com/chasseurmic/TWRCharts) ⭐ 358 | 🐛 13 | 🌐 Objective-C | 📅 2014-06-30 - An iOS wrapper for ChartJS. Easily build animated charts by leveraging the power of native Obj-C code.
...
* [injectionforxcode](https://github.com/johnno1962/injectionforxcode) ⭐ 6,536 | 🐛 76 | 🌐 Objective-C | 📅 2022-08-04 - Code injection including Swift.
* [Inject](https://github.com/krzysztofzablocki/Inject) ⭐ 3,482 | 🐛 0 | 🌐 Swift | 📅 2026-04-29 - Hot Reloading for Swift applications!
...
* [MLeaksFinder](https://github.com/Tencent/MLeaksFinder) ⭐ 5,426 | 🐛 73 | 🌐 Objective-C | 📅 2023-09-11 - Find memory leaks in your iOS app at develop time.
...
* [Bootstrap](https://github.com/krzysztofzablocki/Bootstrap) ⭐ 2,035 | 🐛 3 | 🌐 Objective-C | 📅 2020-10-20 - iOS project bootstrap aimed at high quality coding.
...
* [Swiftlint](https://github.com/realm/SwiftLint) ⭐ 19,732 | 🐛 502 | 🌐 Swift | 📅 2026-09-03 - A tool to enforce Swift style and conventions.
...
* [CoreStore](https://github.com/JohnEstropia/CoreStore) ⭐ 4,050 | 🐛 98 | 🌐 Swift | 📅 2026-07-29 - Powerful Core Data framework for Incremental Migrations, Fetching, Observering, etc.
* [Mogenerator](https://github.com/rentzsch/mogenerator) ⭐ 3,016 | 🐛 22 | 🌐 Objective-C | 📅 2025-06-27 - Automatic Core Data code generation.
* [Sync](https://github.com/3lvis/Sync) ⭐ 2,541 | 🐛 10 | 🌐 Swift | 📅 2026-09-15 - Modern Swift JSON synchronization to Core Data.
...
* [FMDB](https://github.com/ccgus/fmdb) ⭐ 13,829 | 🐛 270 | 🌐 Objective-C | 📅 2026-03-15 - A Cocoa / Objective-C wrapper around SQLite.
...
* [SQLite.swift](https://github.com/stephencelis/SQLite.swift) ⭐ 10,191 | 🐛 139 | 🌐 Swift | 📅 2026-09-13 - A type-safe, Swift-language layer over SQLite3.
* [GRDB.swift](https://github.com/groue/GRDB.swift) ⭐ 8,649 | 🐛 15 | 🌐 Swift | 📅 2026-09-15 - A versatile SQLite toolkit for Swift, with WAL mode support.
...
* [EKAlgorithms](https://github.com/EvgenyKarkan/EKAlgorithms) ⭐ 2,405 | 🐛 6 | 🌐 Objective-C | 📅 2024-09-19 - Some well known CS algorithms & data structures in Objective-C.
...
* [DateTools](https://github.com/MatthewYork/DateTools) ⭐ 7,175 | 🐛 109 | 🌐 Objective-C | 📅 2024-08-21 - Dates and times made easy in Objective-C.
...
* [iso-8601-date-formatter](https://github.com/boredzo/iso-8601-date-formatter) ⭐ 594 | 🐛 24 | 🌐 Objective-C | 📅 2021-05-12 - A Cocoa NSFormatter subclass to convert dates to and from ISO-8601-formatted strings. Supports calendar, week, and ordinal formats.
...
* [Atlantis](https://github.com/ProxymanApp/atlantis) ⭐ 1,585 | 🐛 69 | 🌐 Swift | 📅 2026-07-13 - A little and powerful iOS framework for intercepting HTTP/HTTPS Traffic from your iOS app. No more messing around with proxy and certificate config. Inspect Traffic Log with Proxyman app.
...
* [NetworkEye](https://github.com/coderyi/NetworkEye) ⭐ 1,400 | 🐛 19 | 🌐 Objective-C | 📅 2020-08-24 - a iOS network debug library, It can monitor HTTP requests within the App and displays information related to the request.
...
* [Typhoon](https://github.com/appsquickly/Typhoon) ⭐ 2,686 | 🐛 23 | 🌐 Objective-C | 📅 2020-12-20 - Powerful dependency injection for Objective-C.
...
* [swift-package-manager](https://github.com/apple/swift-package-manager) ⭐ 10,219 | 🐛 1,313 | 🌐 Swift | 📅 2026-09-15 - The Package Manager for the Swift Programming Language.
...
* [deliver](https://github.com/fastlane/fastlane/tree/master/deliver) ⭐ 42,113 | 🐛 666 | 🌐 Ruby | 📅 2026-09-15 - Upload screenshots, metadata and your app to the App Store using a single command.
...
* [snapshot](https://github.com/fastlane/fastlane/tree/master/snapshot) ⭐ 42,113 | 🐛 666 | 🌐 Ruby | 📅 2026-09-15 - Automate taking localized screenshots of your iOS app on every device.
...
* [PromiseKit](https://github.com/mxcl/PromiseKit) ⭐ 14,224 | 🐛 15 | 🌐 Swift | 📅 2026-06-03 - Promises for iOS and macOS.
...
* [ZipArchive](https://github.com/ZipArchive/ZipArchive) ⭐ 5,602 | 🐛 68 | 🌐 C | 📅 2025-10-31 - ZipArchive is a simple utility class for zipping and unzipping files on iOS and Mac.
* [ZIPFoundation](https://github.com/weichsel/ZIPFoundation) ⭐ 2,732 | 🐛 35 | 🌐 Swift | 📅 2026-09-12 - Effortless ZIP Handling in Swift.
...
* [SCRecorder](https://github.com/rFlex/SCRecorder) ⭐ 3,040 | 🐛 233 | 🌐 Objective-C | 📅 2021-05-25 - Camera engine with Vine-like tap to record, animatable filters, slow motion, segments editing.
...
* [YogaKit](https://github.com/facebook/yoga/tree/master/YogaKit) ⭐ 18,908 | 🐛 170 | 🌐 C++ | 📅 2026-09-11 - Powerful layout engine which implements Flexbox.
* [Masonry](https://github.com/SnapKit/Masonry) ⭐ 18,125 | 🐛 151 | 🌐 Objective-C | 📅 2023-04-13 - Harness the power of AutoLayout NSLayoutConstraints with a simplified, chainable and expressive syntax.
...
* [FlexLayout](https://github.com/layoutBox/FlexLayout) ⭐ 2,133 | 🐛 1 | 🌐 Swift | 📅 2026-08-30 - FlexLayout gently wraps the highly optimized [facebook/yoga](https://github.com/facebook/yoga) ⭐ 18,908 | 🐛 170 | 🌐 C++ | 📅 2026-09-11 flexbox implementation in a concise, intuitive & chainable syntax.
...
* [LocalizationKit](https://github.com/willpowell8/LocalizationKit_iOS) ⭐ 1,209 | 🐛 12 | 🌐 Swift | 📅 2019-10-31 - Localization management in realtime from a web portal. Easily manage your texts and translations without redeploy and resubmission.
...
* [CocoaLumberjack](https://github.com/CocoaLumberjack/CocoaLumberjack) ⭐ 13,319 | 🐛 9 | 🌐 Objective-C | 📅 2026-09-15 - A fast & simple, yet powerful & flexible logging framework for Mac and iOS.
* [Pulse](https://github.com/kean/Pulse) ⭐ 7,213 | 🐛 46 | 🌐 Swift | 📅 2026-08-15 - Pulse is a powerful logging system for Apple Platforms. Native. Built with SwiftUI.
...
* [Tensorflow-iOS](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/examples/ios) ⭐ 200,106 | 🐛 3,156 | 🌐 C++ | 📅 2026-09-15 - The official Google-built powerful neural network library port for iOS.
...
* [off-grid-mobile](https://github.com/alichherawalla/off-grid-mobile) ⭐ 3,105 | 🐛 151 | 🌐 TypeScript | 📅 2026-09-15 - Run LLMs, vision models, and Stable Diffusion fully on-device. No internet, no data leaves the phone. React Native, supports iOS and Android. MIT license.
...
* [EZAudio](https://github.com/syedhali/EZAudio) ⭐ 4,978 | 🐛 196 | 🌐 Objective-C | 📅 2025-09-09 - An iOS/macOS audio visualization framework built upon Core Audio useful for anyone doing real-time, low-latency audio processing and visualizations.
* [Porcupine](https://github.com/Picovoice/Porcupine) ⭐ 4,938 | 🐛 0 | 🌐 Python | 📅 2026-09-10 - On-device wake word detection engine for macOS, iOS, and watchOS, powered by deep learning.
* [FluidAudio](https://github.com/FluidInference/FluidAudio) ⭐ 2,765 | 🐛 9 | 🌐 Swift | 📅 2026-09-14 - Swift framework for local speech recognition, speaker diarization, voice activity detection, and text-to-speech using Core ML.
...
* [IQAudioRecorderController](https://github.com/hackiftekhar/IQAudioRecorderController) ⭐ 634 | 🐛 8 | 🌐 Objective-C | 📅 2026-01-02 - A drop-in universal library allows to record audio within the app with a nice User Interface.
...
* [FLAnimatedImage](https://github.com/Flipboard/FLAnimatedImage) ⭐ 7,945 | 🐛 83 | 🌐 Objective-C | 📅 2024-03-21 - Performant animated GIF engine for iOS.
...
* [YLGIFImage](https://github.com/liyong03/YLGIFImage) ⭐ 1,760 | 🐛 14 | 🌐 Objective-C | 📅 2020-12-19 - Async GIF image decoder and Image viewer supporting play GIF images. It just use very less memory.
...
* [FastImageCache](https://github.com/path/FastImageCache) ⭐ 8,054 | 🐛 40 | 🌐 Objective-C | 📅 2023-07-12 - iOS library for quickly displaying images while scrolling.
...
* [TLPhotoPicker](https://github.com/tilltue/TLPhotoPicker) ⭐ 1,896 | 🐛 41 | 🌐 Swift | 📅 2026-06-16 - Multiple phassets picker for iOS lib. like a facebook.
...
* [LFLiveKit](https://github.com/LaiFengiOS/LFLiveKit) ⭐ 4,387 | 🐛 142 | 🌐 Objective-C | 📅 2023-04-07 - H264 and AAC Hard coding，support GPUImage Beauty， rtmp transmission，weak network lost frame，Dynamic switching rate.
* [HaishinKit.swift](https://github.com/shogo4405/HaishinKit.swift) ⭐ 3,067 | 🐛 10 | 🌐 Swift | 📅 2026-09-13 - Camera and Microphone streaming library via RTMP, HLS for iOS, macOS.
...
* [MHVideoPhotoGallery](https://github.com/mariohahn/MHVideoPhotoGallery) ⭐ 1,945 | 🐛 66 | 🌐 Objective-C | 📅 2021-10-06 - A Photo and Video Gallery.
* [VLC for iOS](https://github.com/videolan/vlc-ios) ⭐ 1,299 | 🐛 3 | 🌐 Swift | 📅 2026-09-12 - VLC is a free and open source multimedia player for iOS.
...
* [ExyteChat](https://github.com/exyte/Chat) ⭐ 1,866 | 🐛 3 | 🌐 Swift | 📅 2026-09-07 - SwiftUI Chat UI framework with fully customizable message cells, input view, and a built-in media picker.
...
* [Alamofire](https://github.com/Alamofire/Alamofire) ⭐ 42,420 | 🐛 42 | 🌐 Swift | 📅 2026-09-14 - Alamofire is an HTTP networking library written in Swift, from the creator of AFNetworking.
* [Moya](https://github.com/Moya/Moya) ⭐ 15,357 | 🐛 176 | 🌐 Swift | 📅 2026-07-14 - Network abstraction layer written in Swift.
* [CocoaAsyncSocket](https://github.com/robbiehanson/CocoaAsyncSocket) ⭐ 12,443 | 🐛 0 | 🌐 Objective-C | 📅 2026-08-30 - Asynchronous socket networking library for Mac and iOS.
...
* [YTKNetwork](https://github.com/yuantiku/YTKNetwork) ⭐ 6,541 | 🐛 127 | 🌐 Objective-C | 📅 2021-04-22 - YTKNetwork is a high level request util based on AFNetworking.
...
* [RealReachability](https://github.com/dustturtle/RealReachability) ⭐ 3,099 | 🐛 15 | 🌐 Objective-C | 📅 2026-04-29 - We need to observe the REAL reachability of network. That's what RealReachability do.
...
* [Networking](https://github.com/3lvis/Networking) ⭐ 1,378 | 🐛 4 | 🌐 Swift | 📅 2026-09-15 - Simple HTTP Networking in Swift a NSURLSession wrapper with image caching support.
...
* [PEM](https://github.com/fastlane/fastlane/tree/master/pem) ⭐ 42,113 | 🐛 666 | 🌐 Ruby | 📅 2026-09-15 - Automatically generate and renew your push notification profiles.
...
* [Open Source apps](https://github.com/dkhamsing/open-source-ios-apps) ⭐ 52,135 | 🐛 1 | 📅 2026-09-15 list of open source iOS apps.

* [Awesome list of open source applications for macOS](https://github.com/serhii-londar/open-source-mac-os-apps) ⭐ 50,396 | 🐛 266 | 📅 2026-09-10 - List of awesome open source applications for macOS.

* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,674 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02 list.
...
* [awsome-ios-animation](https://github.com/ameizi/awesome-ios-animation) ⭐ 5,463 | 🐛 0 | 📅 2025-10-28 - A curated list of awesome iOS animation, including Objective-C and Swift libraries.
...
* [awesome-ios-books](https://github.com/bystritskiy/awesome-ios-books) ⭐ 724 | 🐛 0 | 📅 2026-09-15 - A list of books for iOS developers.
...
* [Mantle](https://github.com/Mantle/Mantle) ⭐ 11,248 | 🐛 0 | 🌐 Objective-C | 📅 2022-10-18 - Model framework for Cocoa and Cocoa Touch.
* [ObjectMapper](https://github.com/tristanhimmelman/ObjectMapper) ⭐ 9,132 | 🐛 68 | 🌐 Swift | 📅 2024-05-02 - A framework written in Swift that makes it easy for you to convert your Model objects (Classes and Structs) to and from JSON.
* [MJExtension](https://github.com/CoderMJLee/MJExtension) ⭐ 8,484 | 🐛 29 | 🌐 Objective-C | 📅 2024-03-13 - A fast, convenient and nonintrusive conversion between JSON and model. Your model class don't need to extend another base class. You don't need to modify any model file.
* [JSONModel](https://github.com/JSONModel/JSONModel) ⭐ 6,804 | 🐛 34 | 🌐 Objective-C | 📅 2021-11-06 - Magical Data Modeling Framework for JSON. Create rapidly powerful, atomic and smart data model classes.
...
* [FastEasyMapping](https://github.com/Yalantis/FastEasyMapping) ⭐ 543 | 🐛 18 | 🌐 Objective-C | 📅 2019-12-07 - Serialize & deserialize JSON fast.
...
* [NetNewsWire](https://github.com/Ranchero-Software/NetNewsWire) ⭐ 10,382 | 🐛 636 | 🌐 Swift | 📅 2026-09-05 - It’s a free and open-source feed reader for macOS and iOS.
...
* [Tuist](https://github.com/tuist/tuist) ⭐ 5,803 | 🐛 406 | 🌐 Swift | 📅 2026-09-15 - A tool to create, maintain and interact with Xcode projects at scale.
* [xcproj](https://github.com/tuist/xcodeproj) ⭐ 2,225 | 🐛 20 | 🌐 Swift | 📅 2026-09-15 - Read and update Xcode projects.
...
* [Playgrounds](https://github.com/krzysztofzablocki/Playgrounds) ⭐ 2,623 | 🐛 1 | 🌐 Objective-C | 📅 2022-07-19 - Playgrounds for Objective-C for extremely fast prototyping / learning.
...
* [RxBluetoothKit](https://github.com/Polidea/RxBluetoothKit) ⭐ 1,437 | 🐛 56 | 🌐 Swift | 📅 2024-03-05 - iOS & macOS Bluetooth library for RxSwift.
...
* [Regex](https://github.com/sharplet/Regex) ⭐ 609 | 🐛 6 | 🌐 Swift | 📅 2021-04-13 - A Swift µframework providing an NSRegularExpression-backed Regex type.
...
* [Stripe](https://github.com/stripe/stripe-ios) ⭐ 2,570 | 🐛 294 | 🌐 Swift | 📅 2026-09-15 Stripe bindings for iOS and macOS.
...
* [Adapty](https://github.com/adaptyteam/AdaptySDK-iOS) ⭐ 485 | 🐛 4 | 🌐 C++ | 📅 2026-09-15 - Integrate in-app subscriptions and a/b testing for them with 3 lines of code.
...
* [Apphud](https://github.com/apphud/ApphudSDK) ⭐ 239 | 🐛 1 | 🌐 Swift | 📅 2026-09-15 - A complete solution to integrate auto-renewable subscriptions and regular in-app purchases in 30 minutes with no server code required.
* [algoliasearch-client-swift](https://github.com/algolia/algoliasearch-client-swift) ⭐ 209 | 🐛 6 | 🌐 Swift | 📅 2026-09-15 - Algolia Search API Client for Swift.
* [Box](https://github.com/box/box-ios-sdk) ⭐ 130 | 🐛 6 | 🌐 Swift | 📅 2026-09-15 iOS + macOS SDK for the Box API.
...
* [UICKeyChainStore](https://github.com/kishikawakatsumi/UICKeyChainStore) ⭐ 3,079 | 🐛 24 | 🌐 Objective-C | 📅 2023-10-14 - UICKeyChainStore is a simple wrapper for Keychain on iOS.
...
* [Vapor](https://github.com/vapor/vapor) ⭐ 26,189 | 🐛 83 | 🌐 Swift | 📅 2026-09-15 - Elegant web framework for Swift that works on iOS, macOS, and Ubuntu.
...
* [Kiwi](https://github.com/kiwi-bdd/Kiwi) ⭐ 4,108 | 🐛 89 | 🌐 Objective-C | 📅 2023-09-05 - A behavior-driven development library for iOS development.
* [Specta](https://github.com/specta/specta) ⭐ 2,309 | 🐛 18 | 🌐 Objective-C | 📅 2022-02-27 - A light-weight TDD / BDD framework for Objective-C & Cocoa.
* [SwiftCheck](https://github.com/typelift/SwiftCheck) ⭐ 1,427 | 🐛 24 | 🌐 Swift | 📅 2022-04-03 - QuickCheck for Swift.
* [swift-corelibs-xctest](https://github.com/apple/swift-corelibs-xctest) ⭐ 1,189 | 🐛 26 | 🌐 Swift | 📅 2026-09-15 - The XCTest Project, A Swift core library for providing unit test support.
...
* [EarlGrey](https://github.com/google/EarlGrey) ⭐ 5,692 | 🐛 259 | 🌐 Objective-C | 📅 2026-09-11 - :tea: iOS UI Automation Test Framework.
* [Bluepill](https://github.com/linkedin/bluepill) ⭐ 3,205 | 🐛 54 | 🌐 Objective-C | 📅 2024-08-12 - Bluepill is a reliable iOS testing tool that runs UI tests using multiple simulators on a single machine.
* [ViewInspector](https://github.com/nalexn/ViewInspector) ⭐ 2,631 | 🐛 55 | 🌐 Swift | 📅 2026-09-13 - Runtime inspection and unit testing of SwiftUI views
...
* [SnapshotTesting](https://github.com/pointfreeco/swift-snapshot-testing) ⭐ 4,334 | 🐛 219 | 🌐 Swift | 📅 2026-09-15 - Delightful Swift snapshot testing.
...
* [YYText](https://github.com/ibireme/YYText) ⭐ 8,864 | 🐛 516 | 🌐 Objective-C | 📅 2024-07-16 - Powerful text framework for iOS to display and edit rich text.
...
* [ZSSRichTextEditor](https://github.com/nnhubbard/ZSSRichTextEditor) ⭐ 3,780 | 🐛 131 | 🌐 Objective-C | 📅 2021-09-07 - A beautiful rich text WYSIWYG editor for iOS with a syntax highlighted source view.
...
* [libPhoneNumber-iOS](https://github.com/iziz/libPhoneNumber-iOS) ⭐ 2,384 | 🐛 0 | 🌐 Objective-C | 📅 2026-09-12 - iOS port from libphonenumber (Google's phone number handling library).
...
* [AztecEditor-iOS](https://github.com/wordpress-mobile/AztecEditor-iOS) ⭐ 669 | 🐛 100 | 🌐 Swift | 📅 2026-09-15 - Aztec is a Swift library that provides a `UITextView` subclass with HTML visual-editing capabilities. The plugin API supports customization HTML conversion from/to HTML for compatibility with your needs.
...
* [RKNotificationHub](https://github.com/cwRichardKim/RKNotificationHub) ⭐ 3,028 | 🐛 3 | 🌐 Objective-C | 📅 2018-11-02 - Make any UIView a full fledged notification center.
* [BEMCheckBox](https://github.com/Boris-Em/BEMCheckBox#sample-app) ⭐ 2,608 | 🐛 27 | 🌐 Swift | 📅 2023-08-03 - Tasteful Checkbox for iOS.
* [FDStackView](https://github.com/forkingdog/FDStackView) ⭐ 2,508 | 🐛 30 | 🌐 Objective-C | 📅 2018-01-05 - Use UIStackView directly in iOS.
...
* [OAStackView](https://github.com/nsomar/OAStackView) ⭐ 2,126 | 🐛 26 | 🌐 Objective-C | 📅 2017-03-28 - OAStackView tries to port back the stackview to iOS 7+. OAStackView aims at replicating all the features in UIStackView.
...
* [M13ProgressSuite](https://github.com/Marxon13/M13ProgressSuite) ⭐ 3,897 | 🐛 48 | 🌐 Objective-C | 📅 2022-03-05 - A suite containing many tools to display progress information on iOS.
* [NJKWebViewProgress](https://github.com/ninjinkun/NJKWebViewProgress) ⭐ 3,864 | 🐛 40 | 🌐 Objective-C | 📅 2020-01-04 - A progress interface library for UIWebView. You can implement progress bar for your in-app browser using this module.
...
* [DACircularProgress](https://github.com/danielamitay/DACircularProgress) ⭐ 2,337 | 🐛 29 | 🌐 Objective-C | 📅 2022-09-09 - DACircularProgress is a UIView subclass with circular UIProgressView properties.
...
* [Lottie](https://github.com/airbnb/lottie-ios) ⭐ 26,875 | 🐛 45 | 🌐 Swift | 📅 2026-09-02 - An iOS library for a real time rendering of native vector animations from Adobe After Effects.
...
* [ZFDragableModalTransition](https://github.com/zoonooz/ZFDragableModalTransition) ⭐ 2,444 | 🐛 23 | 🌐 Objective-C | 📅 2018-01-21 - Custom animation transition for present modal view controller.
...
* [SCLAlertView-Swift](https://github.com/vikmeup/SCLAlertView-Swift) ⭐ 5,305 | 🐛 147 | 🌐 Swift | 📅 2024-01-05 - Beautiful animated Alert View, written in Swift.
...
* [JTCalendar](https://github.com/jonathantribouharet/JTCalendar) ⭐ 2,743 | 🐛 118 | 🌐 Objective-C | 📅 2021-12-06 - A customizable calendar view for iOS.
...
* [XLForm](https://github.com/xmartlabs/XLForm) ⭐ 5,729 | 🐛 177 | 🌐 Objective-C | 📅 2024-06-03 - XLForm is the most flexible and powerful iOS library to create dynamic table-view forms. Fully compatible with Swift & Obj-C.
...
* [TPKeyboardAvoiding](https://github.com/michaeltyson/TPKeyboardAvoiding) ⭐ 5,780 | 🐛 103 | 🌐 Objective-C | 📅 2023-09-15 - A drop-in universal solution for moving text fields out of the way of the keyboard in iOS
...
* [MakemojiSDK](https://github.com/makemoji/MakemojiSDK) ⭐ 99 | 🐛 0 | 🌐 Objective-C | 📅 2016-11-11 - Emoji Keyboard SDK (iOS)
...
* [TTTAttributedLabel](https://github.com/TTTAttributedLabel/TTTAttributedLabel) ⭐ 8,703 | 🐛 177 | 🌐 Objective-C | 📅 2024-06-24 - A drop-in replacement for UILabel that supports attributes, data detectors, links, and more
...
* [KYGooeyMenu](https://github.com/KittenYang/KYGooeyMenu) ⭐ 1,902 | 🐛 6 | 🌐 Objective-C | 📅 2022-06-16 - A not bad gooey effects menu.
* [Context-Menu.iOS](https://github.com/Yalantis/Context-Menu.iOS) ⭐ 1,823 | 🐛 3 | 🌐 Objective-C | 📅 2018-04-04 - You can easily add awesome animated context menu to your app.
...
* [LTNavigationBar](https://github.com/ltebean/LTNavigationBar) ⭐ 4,417 | 🐛 36 | 🌐 Objective-C | 📅 2018-09-26 - UINavigationBar Category which allows you to change its appearance dynamically
...
* [PopupController](https://github.com/daisuke310vvv/PopupController) ⭐ 334 | 🐛 23 | 🌐 Swift | 📅 2020-08-06 - A customizable controller for showing temporary popup view.
...
* [PullToMakeSoup](https://github.com/Yalantis/PullToMakeSoup) ⭐ 1,912 | 🐛 4 | 🌐 Objective-C | 📅 2019-03-18 - Custom animated pull-to-refresh that can be easily added to UIScrollView
...
* [HCSStarRatingView](https://github.com/hsousa/HCSStarRatingView) ⭐ 1,259 | 🐛 21 | 🌐 Objective-C | 📅 2023-04-03 - Simple star rating view for iOS written in Objective-C
...
* [SWTableViewCell](https://github.com/CEWendel/SWTableViewCell) ⭐ 7,057 | 🐛 171 | 🌐 Objective-C | 📅 2021-05-20 - An easy-to-use UITableViewCell subclass that implements a swippable content view which exposes utility buttons (similar to iOS 7 Mail Application)
...
* [CSStickyHeaderFlowLayout](https://github.com/CSStickyHeaderFlowLayout/CSStickyHeaderFlowLayout) ⭐ 5,029 | 🐛 24 | 🌐 Objective-C | 📅 2021-07-17 - UICollectionView replacement of UITableView. Do even more like Parallax Header, Sticky Section Header.
...
* [CHTCollectionViewWaterfallLayout](https://github.com/chiahsien/CHTCollectionViewWaterfallLayout) ⭐ 4,610 | 🐛 46 | 🌐 Objective-C | 📅 2026-03-18 - The waterfall (i.e., Pinterest-like) layout for UICollectionView.
...
* [CollectionViewSlantedLayout](https://github.com/yacir/CollectionViewSlantedLayout) ⭐ 2,341 | 🐛 3 | 🌐 Swift | 📅 2021-05-01 - UICollectionViewLayout with slanted content
...
* [AMTagListView](https://github.com/andreamazz/AMTagListView) ⭐ 756 | 🐛 8 | 🌐 Objective-C | 📅 2019-12-19 - UIScrollView subclass that allows to add a list of highly customizable tags.
* [RKTagsView](https://github.com/kuler90/RKTagsView) ⭐ 444 | 🐛 1 | 🌐 Objective-C | 📅 2018-03-26 - Highly customizable iOS tags view (like NSTokenField). Supports editing, multiple selection, Auto Layout and much more.
...
* [JVFloatLabeledTextField](https://github.com/jverdi/JVFloatLabeledTextField) ⭐ 7,134 | 🐛 28 | 🌐 Objective-C | 📅 2023-04-17 - UITextField subclass with floating labels.
...
* [SVWebViewController](https://github.com/TransitApp/SVWebViewController) ⭐ 2,551 | 🐛 74 | 🌐 Objective-C | 📅 2020-04-30 - A drop-in inline browser for your iOS app.
...
* [MMWormhole](https://github.com/mutualmobile/MMWormhole) ⭐ 3,931 | 🐛 19 | 🌐 Objective-C | 📅 2024-02-02 - Message passing between iOS apps and extensions.
...
* [BFKit](https://github.com/FabrizioBrancati/BFKit) ⭐ 791 | 🐛 1 | 🌐 Objective-C | 📅 2020-05-25 - An Objective-C collection of useful classes to develop Apps faster.
...
* [JazzHands](https://github.com/IFTTT/JazzHands) ⭐ 6,354 | 🐛 14 | 🌐 Objective-C | 📅 2024-07-30 - Jazz Hands is a simple keyframe-based animation framework for UIKit. Animations can be controlled via gestures, scroll views, KVO, or ReactiveCocoa.
...
* [SocketRocket](https://github.com/facebook/SocketRocket) ⭐ 9,603 | 🐛 190 | 🌐 Objective-C | 📅 2025-12-04 - A conforming Objective-C WebSocket client library.
...
* [infer](https://github.com/facebook/infer) ⭐ 15,705 | 🐛 208 | 🌐 OCaml | 📅 2026-09-10 - A static analyzer for Java, C and Objective-C.
...
* [XcodeGen](https://github.com/yonaskolb/XcodeGen) ⭐ 8,779 | 🐛 400 | 🌐 Swift | 📅 2026-09-13 - Command line tool that generates your Xcode project from a spec file and your folder structure.
* [Xcodes.app](https://github.com/RobotsAndPencils/XcodesApp) ⭐ 8,537 | 🐛 223 | 🌐 Swift | 📅 2026-09-14 - The easiest way to install and switch between multiple versions of Xcode.
...
* [FBSimulatorControl](https://github.com/facebook/idb) ⭐ 5,331 | 🐛 182 | 🌐 Swift | 📅 2026-09-15 - A macOS library for managing and manipulating iOS Simulators
...
* [Pecker](https://github.com/woshiccm/Pecker) ⭐ 1,460 | 🐛 12 | 🌐 Swift | 📅 2022-04-08 - CodePecker is a tool to detect unused code.
...
* [SBShortcutMenuSimulator](https://github.com/DeskConnect/SBShortcutMenuSimulator) ⭐ 1,731 | 🐛 13 | 🌐 Objective-C | 📅 2016-12-11 - 3D Touch shortcuts in the Simulator.
